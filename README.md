...
- Ключ шифрования и IV хранятся в байтовых массивах (обфускация от тривиального поиска строк в скомпилированном бинарнике)
...
- `android/tun2socks/` — библиотека для туннелирования трафика
- `tun_fdwrap/` — враппер для работы с TUN-дескриптором на уровне ОС
